document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        // Checkbox validation is handled by 'required' attribute in HTML,
        // but double check here if needed.
        
        // Simulate sending email
        console.log('Sending email to primarnoplava@gmail.com...');
        console.log(`From: ${nick}`);
        console.log(`Content: ${answer}`);
        
        if (audioChunks.length > 0) {
            console.log('Attaching voice memo...');
        }
        ...
        setTimeout(() => {
            ...
            console.log('Email successfully "sent" (mocked).');
        }, 1500);
    });
});
